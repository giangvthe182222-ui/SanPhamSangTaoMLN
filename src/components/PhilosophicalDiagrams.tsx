...
const TOPIC_SLIDES: SlideData[] = [
  {
    ...
    subtitle: "Sự thống nhất của ba phương diện",
    icon: <Layers className="w-6 h-6" />,
    description: "Dân chủ XHCN là sự kết hợp biện chứng giữa quyền lực nhân dân (Chính trị), sở hữu công hữu (Kinh tế) và hệ tư tưởng Mác-Lênin (Văn hóa)."
  },
  {
    id: 2,
    title: "Biện chứng Dân chủ & Pháp luật",
    subtitle: "Tự do trong khuôn khổ kỷ cương",
    icon: <Scale className="w-6 h-6" />,
    description: "Dân chủ không phải là tự do vô chính phủ. Pháp luật là công cụ bảo vệ quyền dân chủ và ngăn ngừa sự lạm dụng quyền tự do xâm phạm lợi ích chung."
  },
  {
    id: 3,
    title: "Không gian mạng & Quyền Ngôn luận",
    subtitle: "Môi trường thực thi dân chủ hiện đại",
    icon: <Globe className="w-6 h-6" />,
    description: "Với 78 triệu người dùng, mạng xã hội tại Việt Nam là diễn đàn khổng lồ để người dân thực hiện quyền giám sát và đóng góp ý kiến cho Nhà nước."
  },
  {
    id: 4,
    title: "Nhận diện Thách thức Số",
    subtitle: "Tin giả và Diễn biến hòa bình",
    icon: <AlertTriangle className="w-6 h-6" />,
    description: "Các thế lực thù địch lợi dụng mạng xã hội để bôi nhọ, xuyên tạc và gây mất ổn định xã hội thông qua các thủ đoạn tin giả tinh vi."
  },
  {
    id: 5,
    title: "Chân dung Công dân số",
    subtitle: "Trách nhiệm và Đạo đức mạng",
    icon: <UserCheck className="w-6 h-6" />,
    description: "Người có đủ năng lực nhận thức, biết kiểm chứng thông tin (fact-check) và có hành xử văn minh trên môi trường internet."
  }
];
